...
use Venusian\Tests\Bus\Fixtures\ChainHeadJob;
use Venusian\Tests\Bus\Fixtures\SecondTestJob;
use Venusian\Tests\Bus\Fixtures\ThirdTestJob;
...
beforeEach(function () {
    ...
    if (! MagicAlias::getMagicAliasApplication()) {
        ...
        $vessel->registerInstance(Factory::class, $queue);
        ...
        $vessel->registerInstance(BusDispatcher::class, $dispatcher);
...
test('batch finished event is dispatched', function () {
        Vessel::getInstance()->registerInstance(EventDispatcher::class, $events = Mockery::mock(EventDispatcher::class));
