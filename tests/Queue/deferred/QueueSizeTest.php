...
beforeEach(function () {
    ...
    $this->app->registerSingleton('queue', fn ($app) => new QueueManager($app));
    $this->app->registerSingleton(QueueFactory::class, fn ($app) => $app['queue']);
    $this->app->registerSingleton(BusDispatcher::class, fn ($app) => new BusDispatcher(
