 ...
 */
function integrationConnection($connection = 'default')
{
 ...
 */
function integrationSchema($connection = 'default')
{
    return integrationConnection($connection)->getSchemaBuilder();
}

function integrationCreateSchema()
{
    integrationSchema('default')->create('test_orders', function ($table) {
        $table->increments('id');
    ...
    integrationSchema('default')->create('with_json', function ($table) {
        $table->increments('id');
        $table->text('json')->default(json_encode([]));
    });

    integrationSchema('second_connection')->create('test_items', function ($table) {
        $table->increments('id');
        $table->timestamps();
    });

    integrationSchema('default')->create('users_with_space_in_column_name', function ($table) {
        $table->increments('id');
    ...
    integrationSchema()->create('users_having_uuids', function (Blueprint $table) {
        $table->id();
        $table->uuid();
        $table->string('name');
    ...
    foreach (['default', 'second_connection'] as $connection) {
        integrationSchema($connection)->create('users', function ($table) {
            $table->increments('id');
            $table->string('name')->nullable();
            $table->string('email');
        ...
        integrationSchema($connection)->create('unique_users', function ($table) {
            $table->increments('id');
            $table->string('name')->nullable();
        ...
        integrationSchema($connection)->create('friends', function ($table) {
            $table->integer('user_id');
            $table->integer('friend_id');
            $table->integer('friend_level_id')->nullable();
        });

        integrationSchema($connection)->create('posts', function ($table) {
            $table->increments('id');
            $table->integer('user_id');
        ...
        integrationSchema($connection)->create('comments', function ($table) {
            $table->increments('id');
        ...
        integrationSchema($connection)->create('friend_levels', function ($table) {
            $table->increments('id');
            $table->string('level');
            $table->timestamps();
        });

        integrationSchema($connection)->create('photos', function ($table) {
            $table->increments('id');
        ...
        integrationSchema($connection)->create('soft_deleted_users', function ($table) {
            $table->increments('id');
            $table->string('name')->nullable();
            $table->string('email');
            $table->timestamps();
        ...
        integrationSchema($connection)->create('tags', function ($table) {
            $table->increments('id');
            $table->string('name');
            $table->timestamps();
        });

        integrationSchema($connection)->create('taggables', function ($table) {
            $table->integer('tag_id');
            $table->morphs('taggable');
            $table->string('taxonomy')->nullable();
        });

        integrationSchema($connection)->create('categories', function ($table) {
            $table->increments('id');
            $table->string('name');
            $table->integer('parent_id')->nullable();
            $table->timestamps();
        ...
        integrationSchema($connection)->create('achievements', function ($table) {
            $table->increments('id');
            $table->integer('status')->nullable();
        });

        integrationSchema($connection)->create('instrument_test_achievement_instrument_test_user', function ($table) {
            $table->integer('instrument_test_achievement_id');
            $table->integer('instrument_test_user_id');
        });
    }

    integrationSchema($connection)->create('non_incrementing_users', function ($table) {
        $table->string('name')->nullable();
    });
}
...
afterEach(function () {
    foreach (['default', 'second_connection'] as $connection) {
        integrationSchema($connection)->drop('users');
        integrationSchema($connection)->drop('friends');
        integrationSchema($connection)->drop('posts');
        integrationSchema($connection)->drop('friend_levels');
        integrationSchema($connection)->drop('photos');
    }
...
test('basic model retrieval', function () {
...
test('basic model collection retrieval', function () {
    InstrumentTestUser::insert([['id' => 1, 'email' => 'taylorotwell@gmail.com'], ['id' => 2, 'email' => 'abigailotwell@gmail.com']]);
...
test('paginated model collection retrieval', function () {
...
test('paginated model collection retrieval using callable per page', function () {
    InstrumentTestUser::insert([
        ['id' => 1, 'email' => 'taylorotwell@gmail.com'],
        ['id' => 2, 'email' => 'abigailotwell@gmail.com'],
        ['id' => 3, 'email' => 'foo@gmail.com'],
...
test('paginated model collection retrieval when no elements', function () {
    Paginator::currentPageResolver(function () {
        return 1;
    });
    $models = InstrumentTestUser::oldest('id')->paginate(2);
...
test('paginated model collection retrieval when no elements and default per page', function () {
...
test('count for pagination with grouping', function () {
    InstrumentTestUser::insert([
        ['id' => 1, 'email' => 'taylorotwell@gmail.com'],
        ['id' => 2, 'email' => 'abigailotwell@gmail.com'],
        ['id' => 3, 'email' => 'foo@gmail.com'],
...
test('count for pagination with grouping and sub selects', function () {
    InstrumentTestUser::insert([
        ['id' => 1, 'email' => 'taylorotwell@gmail.com'],
        ['id' => 2, 'email' => 'abigailotwell@gmail.com'],
        ['id' => 3, 'email' => 'foo@gmail.com'],
...
test('cursor paginated model collection retrieval', function () {
    InstrumentTestUser::insert([
        ['id' => 1, 'email' => 'taylorotwell@gmail.com'],
...
test('previous cursor paginated model collection retrieval', function () {
    InstrumentTestUser::insert([
        ['id' => 1, 'email' => 'taylorotwell@gmail.com'],
        ['id' => 2, 'email' => 'abigailotwell@gmail.com'],
...
test('cursor paginated model collection retrieval when no elements', function () {
    CursorPaginator::currentCursorResolver(function () {
        return null;
    });
    $models = InstrumentTestUser::oldest('id')->cursorPaginate(2);
...
test('cursor paginated model collection retrieval when no elements and default per page', function () {
...
test('create or first non attribute field violation', function () {
...
test('create or first within transaction', function () {
...
test('update or create on different connection', function () {
...
test('check and create methods on multi connections', function () {
...
test('creating model with empty attributes', function () {
...
test('chunks with limits where limit is less than total', function () {
    InstrumentTestUser::insert([
        ['name' => 'First', 'email' => 'first@example.com'],
        ['name' => 'Second', 'email' => 'second@example.com'],
        ['name' => 'Third', 'email' => 'third@example.com'],
...
test('chunks with limits where limit is more than total', function () {
    InstrumentTestUser::insert([
        ['name' => 'First', 'email' => 'first@example.com'],
        ['name' => 'Second', 'email' => 'second@example.com'],
        ['name' => 'Third', 'email' => 'third@example.com'],
...
test('chunks with offset', function () {
    InstrumentTestUser::insert([
        ['name' => 'First', 'email' => 'first@example.com'],
        ['name' => 'Second', 'email' => 'second@example.com'],
        ['name' => 'Third', 'email' => 'third@example.com'],
...
test('chunks with offset where more than total', function () {
    InstrumentTestUser::insert([
        ['name' => 'First', 'email' => 'first@example.com'],
        ['name' => 'Second', 'email' => 'second@example.com'],
        ['name' => 'Third', 'email' => 'third@example.com'],
...
test('chunks with limits and offsets', function () {
    InstrumentTestUser::insert([
        ['name' => 'First', 'email' => 'first@example.com'],
        ['name' => 'Second', 'email' => 'second@example.com'],
        ['name' => 'Third', 'email' => 'third@example.com'],
...
test('chunk by id with limits', function () {
    InstrumentTestUser::insert([
        ['name' => 'First', 'email' => 'first@example.com'],
        ['name' => 'Second', 'email' => 'second@example.com'],
        ['name' => 'Third', 'email' => 'third@example.com'],
...
test('chunk by id with offsets', function () {
    InstrumentTestUser::insert([
        ['name' => 'First', 'email' => 'first@example.com'],
        ['name' => 'Second', 'email' => 'second@example.com'],
        ['name' => 'Third', 'email' => 'third@example.com'],
...
test('chunk by id with limits and offsets', function () {
    InstrumentTestUser::insert([
        ['name' => 'First', 'email' => 'first@example.com'],
        ['name' => 'Second', 'email' => 'second@example.com'],
        ['name' => 'Third', 'email' => 'third@example.com'],
...
test('chunk by id with non incrementing key', function () {
...
test('each by id with non incrementing key', function () {
    InstrumentTestNonIncrementingSecond::insert([
        ['name' => ' First'],
        ['name' => ' Second'],
        ['name' => ' Third'],
...
test('pluck with column name containing a space', function () {
...
test('find or fail with single id throws model not found exception', function () {
...
test('find or fail with multiple ids throws model not found exception', function () {
    $this->expectException(ModelNotFoundException::class);
...
test('find or fail with multiple ids using collection throws model not found exception', function () {
    $this->expectException(ModelNotFoundException::class);
    $this->expectExceptionMessage('No query results for model [Tests\Database\InstrumentTestUser] 2, 3');
    $this->expectExceptionObject(
        (new ModelNotFoundException())->setModel(InstrumentTestUser::class, [2, 3]),
...
test('one to one relationship', function () {
...
test('isset loads in relationship if it isnt loaded already', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
    $user->post()->create(['name' => 'First Post']);
...
test('first or new on has one relation ship', function () {
    $user1 = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
...
test('first or create on has one relation ship', function () {
    $user1 = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
...
test('has on self referencing belongs to many relationship', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
...
test('where has on self referencing belongs to many relationship', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
    $user->friends()->create(['email' => 'abigailotwell@gmail.com']);
...
test('with where has on self referencing belongs to many relationship', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
    $user->friends()->create(['email' => 'abigailotwell@gmail.com']);
...
test('has on nested self referencing belongs to many relationship', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
...
test('where has on nested self referencing belongs to many relationship', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
    $friend = $user->friends()->create(['email' => 'abigailotwell@gmail.com']);
    $friend->friends()->create(['email' => 'foo@gmail.com']);
...
test('with where has on nested self referencing belongs to many relationship', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
    $friend = $user->friends()->create(['email' => 'abigailotwell@gmail.com']);
    $friend->friends()->create(['email' => 'foo@gmail.com']);
...
test('has on self referencing belongs to many relationship with where pivot', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
    $user->friends()->create(['email' => 'abigailotwell@gmail.com']);
...
test('has on nested self referencing belongs to many relationship with where pivot', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
    $friend = $user->friends()->create(['email' => 'abigailotwell@gmail.com']);
    $friend->friends()->create(['email' => 'foo@gmail.com']);
...
test('has on self referencing belongs to relationship', function () {
...
test('aggregated values of datetime field', function () {
    InstrumentTestUser::insert([
...
test('where has on self referencing belongs to relationship', function () {
    $parentPost = InstrumentTestPost::create(['name' => 'Parent Post', 'user_id' => 1]);
    InstrumentTestPost::create(['name' => 'Child Post', 'parent_id' => $parentPost->id, 'user_id' => 2]);
...
test('with where has on self referencing belongs to relationship', function () {
    $parentPost = InstrumentTestPost::create(['name' => 'Parent Post', 'user_id' => 1]);
    InstrumentTestPost::create(['name' => 'Child Post', 'parent_id' => $parentPost->id, 'user_id' => 2]);
...
test('has on nested self referencing belongs to relationship', function () {
...
test('where has on nested self referencing belongs to relationship', function () {
    $grandParentPost = InstrumentTestPost::create(['name' => 'Grandparent Post', 'user_id' => 1]);
    $parentPost = InstrumentTestPost::create(['name' => 'Parent Post', 'parent_id' => $grandParentPost->id, 'user_id' => 2]);
    InstrumentTestPost::create(['name' => 'Child Post', 'parent_id' => $parentPost->id, 'user_id' => 3]);
...
test('with where has on nested self referencing belongs to relationship', function () {
    $grandParentPost = InstrumentTestPost::create(['name' => 'Grandparent Post', 'user_id' => 1]);
    $parentPost = InstrumentTestPost::create(['name' => 'Parent Post', 'parent_id' => $grandParentPost->id, 'user_id' => 2]);
    InstrumentTestPost::create(['name' => 'Child Post', 'parent_id' => $parentPost->id, 'user_id' => 3]);
...
test('has on self referencing has many relationship', function () {
    $parentPost = InstrumentTestPost::create(['name' => 'Parent Post', 'user_id' => 1]);
    InstrumentTestPost::create(['name' => 'Child Post', 'parent_id' => $parentPost->id, 'user_id' => 2]);
...
test('where has on self referencing has many relationship', function () {
    $parentPost = InstrumentTestPost::create(['name' => 'Parent Post', 'user_id' => 1]);
    InstrumentTestPost::create(['name' => 'Child Post', 'parent_id' => $parentPost->id, 'user_id' => 2]);
...
test('with where has on self referencing has many relationship', function () {
    $parentPost = InstrumentTestPost::create(['name' => 'Parent Post', 'user_id' => 1]);
    InstrumentTestPost::create(['name' => 'Child Post', 'parent_id' => $parentPost->id, 'user_id' => 2]);
...
test('has on nested self referencing has many relationship', function () {
    $grandParentPost = InstrumentTestPost::create(['name' => 'Grandparent Post', 'user_id' => 1]);
    $parentPost = InstrumentTestPost::create(['name' => 'Parent Post', 'parent_id' => $grandParentPost->id, 'user_id' => 2]);
    InstrumentTestPost::create(['name' => 'Child Post', 'parent_id' => $parentPost->id, 'user_id' => 3]);
...
test('where has on nested self referencing has many relationship', function () {
    $grandParentPost = InstrumentTestPost::create(['name' => 'Grandparent Post', 'user_id' => 1]);
    $parentPost = InstrumentTestPost::create(['name' => 'Parent Post', 'parent_id' => $grandParentPost->id, 'user_id' => 2]);
    InstrumentTestPost::create(['name' => 'Child Post', 'parent_id' => $parentPost->id, 'user_id' => 3]);
...
test('with where has on nested self referencing has many relationship', function () {
    $grandParentPost = InstrumentTestPost::create(['name' => 'Grandparent Post', 'user_id' => 1]);
    $parentPost = InstrumentTestPost::create(['name' => 'Parent Post', 'parent_id' => $grandParentPost->id, 'user_id' => 2]);
    InstrumentTestPost::create(['name' => 'Child Post', 'parent_id' => $parentPost->id, 'user_id' => 3]);
...
test('has with non where bindings', function () {
...
test('has on morph to relationship', function () {
...
test('belongs to many relationship models are properly hydrated with sole query', function () {
...
test('belongs to many relationship missing model exception with sole query works', function () {
    $user = InstrumentTestUserWithCustomFriendPivot::create(['email' => 'taylorotwell@gmail.com']);
    $user->friends()->where('email', 'abigailotwell@gmail.com')->sole();
})->throws(ModelNotFoundException::class);

test('belongs to many relationship models are properly hydrated over chunked request', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
    $friend = $user->friends()->create(['email' => 'abigailotwell@gmail.com']);
...
test('belongs to many relationship models are properly hydrated over each request', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
    $friend = $user->friends()->create(['email' => 'abigailotwell@gmail.com']);
...
test('belongs to many relationship models are properly hydrated over cursor request', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
    $friend = $user->friends()->create(['email' => 'abigailotwell@gmail.com']);
...
test('basic has many eager loading', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
    $user->posts()->create(['name' => 'First Post']);
...
test('basic nested self referencing has many eager loading', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
...
test('basic morph many relationship', function () {
    $user = InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
...
test('morph map is used for creating and fetching through relation', function () {
    Relation::morphMap([
...
test('morph map is used when fetching parent', function () {
    Relation::morphMap([
        'user' => InstrumentTestUser::class,
        'post' => InstrumentTestPost::class,
    ]);
...
test('morph map is merged by default', function () {
    $map1 = [
        'user' => InstrumentTestUser::class,
    ];
    $map2 = [
...
test('morph map overwrites current map', function () {
    $map1 = [
        'user' => InstrumentTestUser::class,
    ];
    $map2 = [
...
test('empty morph to relationship', function () {
    $photo = new InstrumentTestPhoto;

    $this->assertNull($photo->imageable);
});

test('save or fail', function () {
    $date = '1970-01-01';
...
test('saving j s o n fields', function () {
...
test('save or fail with duplicated entry', function () {
    $date = '1970-01-01';
    ...
    $post->saveOrFail();
})->throws(QueryException::class, 'SQLSTATE[23000]:');

test('multi inserts with different values', function () {
    $date = '1970-01-01';
...
test('multi inserts with same values', function () {
    $date = '1970-01-01';
    $result = InstrumentTestPost::insert([
        ['user_id' => 1, 'name' => 'Post', 'created_at' => $date, 'updated_at' => $date],
        ['user_id' => 1, 'name' => 'Post', 'created_at' => $date, 'updated_at' => $date],
...
test('nested transactions', function () {
    ...
    integrationConnection()->transaction(function () use ($user) {
        try {
            integrationConnection()->transaction(function () use ($user) {
...
test('nested transactions using save or fail will succeed', function () {
    $user = InstrumentTestUser::create(['email' => 'taylor@laravel.com']);
    integrationConnection()->transaction(function () use ($user) {
        try {
            $user->email = 'otwell@laravel.com';
...
test('nested transactions using save or fail will fails', function () {
    $user = InstrumentTestUser::create(['email' => 'taylor@laravel.com']);
    integrationConnection()->transaction(function () use ($user) {
        try {
            $user->id = 'invalid';
...
test('to array includes default formatted timestamps', function () {
...
test('to array includes custom formatted timestamps', function () {
...
test('incrementing primary keys are cast to integers by default', function () {
    InstrumentTestUser::create(['email' => 'taylorotwell@gmail.com']);
...
test('default incrementing primary key integer cast can be overwritten', function () {
...
test('relations are preloaded in global scope', function () {
...
test('model ignored by global scope can be refreshed', function () {
    $user = InstrumentTestUserWithOmittingGlobalScope::create(['id' => 1, 'email' => 'taylorotwell@gmail.com']);

    $this->assertNotNull($user->fresh());
});

test('global scope can be removed by other global scope', function () {
...
test('for page before id correctly paginates', function () {
    InstrumentTestUser::insert([
        ['id' => 1, 'email' => 'taylorotwell@gmail.com'],
        ['id' => 2, 'email' => 'abigailotwell@gmail.com'],
    ]);
...
test('for page after id correctly paginates', function () {
    InstrumentTestUser::insert([
        ['id' => 1, 'email' => 'taylorotwell@gmail.com'],
        ['id' => 2, 'email' => 'abigailotwell@gmail.com'],
    ]);
...
test('morph to relations across database connections', function () {
    $item = null;
...
test('eager loaded morph to relations on another database connection', function () {
...
test('belongs to many custom pivot', function () {
...
test('is after retrieving the same model', function () {
...
test('fresh method on model', function () {
...
test('fresh method on collection', function () {
...
test('timestamps using default date format', function () {
    $model = new InstrumentTestUser;
...
test('timestamps using default sql server date format', function () {
    $model = new InstrumentTestUser;
...
test('timestamps using custom date format', function () {
...
test('timestamps using old sql server date format', function () {
    $model = new InstrumentTestUser;
...
test('timestamps using old sql server date format fallback to default parsing', function () {
    $model = new InstrumentTestUser;
    $model->setDateFormat('Y-m-d H:i:s.000'); // Old SQL Server date format
    $model->setRawAttributes([
        'updated_at' => '2017-11-14 08:23:19.734',
...
test('updating child model touches parent', function () {
    $before = Carbon::now();
...
test('multi level touching works', function () {
    $before = Carbon::now();
...
test('deleting child model touches parent timestamps', function () {
    $before = Carbon::now();
...
test('touching child model updates parents timestamps', function () {
    $before = Carbon::now();
...
test('touching child model respects parent no touching', function () {
    $before = Carbon::now();
...
test('updating child post respects no touching definition', function () {
    $before = Carbon::now();
...
test('updating model in the disabled scope touches its own timestamps', function () {
    $before = Carbon::now();
...
test('deleting child model respects the no touching rule', function () {
    $before = Carbon::now();
...
test('respected multi level touching chain', function () {
    $before = Carbon::now();
...
test('touches great parent even when parent is in no touch scope', function () {
    $before = Carbon::now();
...
test('can nest calls of no touching', function () {
    $before = Carbon::now();
...
test('can pass array of models to ignore', function () {
    $before = Carbon::now();
...
test('when base model is ignored all child models are ignored', function () {
...
test('child models are ignored', function () {
    $this->assertFalse(Model::isIgnoringTouch());
    $this->assertFalse(InstrumentTestUser::isIgnoringTouch());
...
test('pivots can be refreshed', function () {
...
test('morph pivots can be refreshed', function () {
...
test('touching chaperoned child model updates parent timestamps', function () {
    $before = Carbon::now();
...
test('touching bi directional chaperoned model updates all related timestamps', function () {
    $before = Carbon::now();
...
test('can fill and insert', function () {
    DB::enableQueryLog();
...
test('can fill and insert with unique string ids', function () {
...
test('fill and insert or ignore', function () {
    Str::createUuidsUsingSequence([
        '00000000-0000-7000-0000-000000000000',
        '11111111-0000-7000-0000-000000000000',
        '22222222-0000-7000-0000-000000000000',
...
test('fill and insert get id', function () {
    Str::createUuidsUsingSequence([
        '00000000-0000-7000-0000-000000000000',
    ]);
