...
class DatabaseInstrumentCollectionTest extends TestCase
{
    ...
    public function testFindOrFailFindsManyModelsById()
    {
        ...
        $this->expectExceptionMessage('No query results for model [Tests\Database\TestInstrumentCollectionModel] 3');
    ...
    public function testFindOrFailThrowsExceptionWithMessageWhenOtherModelsArePresent()
    {
        ...
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessage('No query results for model [Tests\Database\TestInstrumentCollectionModel] 2');
    ...
    public function testQueueableCollectionImplementation()
    {
        ...
        $this->assertEquals(TestInstrumentCollectionModel::class, $c->getQueueableClass());
    }
    ...
    public function testCanConvertCollectionOfModelsToInstrumentQueryBuilder()
    {
        $one = m::mock(Model::class);
        $one->shouldReceive('getKey')->andReturn(1);
    ...
    public function testPluck()
    {
        ...
        $this->assertEquals(['John (US)', 'Jane (NL)', 'Taylor (US)'], $c->pluck(fn (TestInstrumentCollectionModel $model) => "{$model->name} ({$model->country})")->all());
    }
    ...
    {
        $user = InstrumentTestUserModel::create(['id' => 1, 'email' => 'taylorotwell@gmail.com']);
