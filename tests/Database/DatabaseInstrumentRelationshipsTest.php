...
test('standard relationships', function () {
    $post = new Post;
...
test('overridden relationships', function () {
    $post = new CustomPost;
...
test('always unset belongs to relation when received model id', function () {
    // create users
...
test('pending has through relationship', function () {
...
test('stringy has through api', function () {
    $fluent = (new FluentMechanic())->owner();
...
test('higher order has through api', function () {
    $fluent = (new FluentMechanic())->owner();
