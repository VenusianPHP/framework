...
function softDeletingScopeBuilder(): InstrumentBuilder
{
    return new InstrumentBuilder(new BaseBuilder(
...
test('applying scope to a builder', function () {
...
test('restore extension', function () {
    $builder = softDeletingScopeBuilder();
...
test('restore or create extension', function () {
    $builder = softDeletingScopeBuilder();
...
test('create or restore extension', function () {
    $builder = softDeletingScopeBuilder();
...
test('with trashed extension', function () {
    $builder = softDeletingScopeBuilder();
...
test('only trashed extension', function () {
    $builder = softDeletingScopeBuilder();
    $model = m::mock(Model::class);
    $model->makePartial();
    $scope = m::mock(SoftDeletingScope::class.'[remove]');
...
test('without trashed extension', function () {
    $builder = softDeletingScopeBuilder();
    $model = m::mock(Model::class);
    $model->makePartial();
    $scope = m::mock(SoftDeletingScope::class.'[remove]');
