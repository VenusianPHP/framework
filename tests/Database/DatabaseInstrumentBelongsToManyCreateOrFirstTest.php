...
function dbBtmCreateOrFirstMockConnectionForModels(array $models, string $database, array $lastInsertIds = []): void
{
...
test('create or first method creates new related', function (Closure|array $values) {
    $source = new BelongsToManyCreateOrFirstTestSourceModel();
    $source->id = 123;
    dbBtmCreateOrFirstMockConnectionForModels(
...
test('create or first method associates existing related', function () {
    $source = new BelongsToManyCreateOrFirstTestSourceModel();
    $source->id = 123;
    dbBtmCreateOrFirstMockConnectionForModels(
        [$source, new BelongsToManyCreateOrFirstTestRelatedModel()],
...
test('first or create method retrieves existing related already associated', function () {
    $source = new BelongsToManyCreateOrFirstTestSourceModel();
    $source->id = 123;
    $source->exists = true;
    dbBtmCreateOrFirstMockConnectionForModels(
...
test('create or first method retrieves existing related associated just now', function () {
    $source = new BelongsToManyCreateOrFirstTestSourceModel();
    $source->id = 123;
    $source->exists = true;
    dbBtmCreateOrFirstMockConnectionForModels(
...
test('first or create method retrieves existing related and associates it', function () {
    $source = new BelongsToManyCreateOrFirstTestSourceModel();
    $source->id = 123;
    $source->exists = true;
    dbBtmCreateOrFirstMockConnectionForModels(
...
test('first or create method falls back to create or first', function () {
...
test('update or create method creates new related', function () {
    $source = new class() extends BelongsToManyCreateOrFirstTestSourceModel
    {
        protected function newBelongsToMany(Builder $query, Model $parent, $table, $foreignPivotKey, $relatedPivotKey, $parentKey, $relatedKey, $relationName = null): BelongsToMany
        {
...
test('update or create method updates existing related', function () {
    $source = new class() extends BelongsToManyCreateOrFirstTestSourceModel
    {
        protected function newBelongsToMany(Builder $query, Model $parent, $table, $foreignPivotKey, $relatedPivotKey, $parentKey, $relatedKey, $relationName = null): BelongsToMany
        {
