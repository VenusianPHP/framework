...
class DatabaseInstrumentModelTest extends TestCase
{
    ...
    public function testDestroyMethodCallsQueryBuilderCorrectlyWithInstrumentCollection()
    {
    ...
    public function testNewQueryReturnsInstrumentQueryBuilder()
    {
    ...
    public function testGetModelAttributeMethodThrowsExceptionIfNotRelation()
    {
        ...
        $this->expectExceptionMessage('Tests\Database\InstrumentModelStub::incorrectRelationStub must return a relationship instance.');
    ...
    public function testModelAttributeCastingFailsOnUnencodableData()
    {
        ...
        $this->expectExceptionMessage('Unable to encode attribute [objectAttribute] for model [Tests\Database\InstrumentModelCastingStub] to JSON: Malformed UTF-8 characters, possibly incorrectly encoded.');
    ...
    {
        $this->expectException(JsonEncodingException::class);
        $this->expectExceptionMessage('Unable to encode attribute [jsonAttribute] for model [Tests\Database\InstrumentModelCastingStub] to JSON: Malformed UTF-8 characters, possibly incorrectly encoded.');
    ...
    {
        $this->expectException(JsonEncodingException::class);
        $this->expectExceptionMessage('Unable to encode attribute [jsonAttributeWithUnicode] for model [Tests\Database\InstrumentModelCastingStub] to JSON: Malformed UTF-8 characters, possibly incorrectly encoded.');
    ...
    public function testUseCustomBuilderWithUseInstrumentBuilderAttribute()
    {
    ...
    public function testDefaultBuilderIsUsedWhenUseInstrumentBuilderAttributeIsNotPresent()
    {
