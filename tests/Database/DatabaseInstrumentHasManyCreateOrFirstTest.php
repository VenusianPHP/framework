...
function dbHasManyCreateOrFirstMockConnectionForModel(Model $model, string $database, array $lastInsertIds = []): void
{
...
test('create or first method creates new record', function (Closure|array $values) {
    ...
    $model->id = 123;
    dbHasManyCreateOrFirstMockConnectionForModel($model, 'SQLite', [456]);
...
test('create or first method retrieves existing record', function () {
    $model = new HasManyCreateOrFirstTestParentModel();
    $model->id = 123;
    dbHasManyCreateOrFirstMockConnectionForModel($model, 'SQLite');
    $model->getConnection()->shouldReceive('transactionLevel')->andReturn(0);
    $model->getConnection()->shouldReceive('getName')->andReturn('sqlite');
