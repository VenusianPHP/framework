...
class ValidationUniqueRuleTest extends TestCase
{
    ...
    public function testItCorrectlyFormatsAStringVersionOfTheRule()
    {
        ...
        $rule = new Unique('Tests\Validation\NoTableName');
        $rule->where('foo', 'bar');
        $this->assertSame('unique:no_table_names,NULL,NULL,id,foo,"bar"', (string) $rule);
        ...
        $this->assertSame('unique:'.PrefixedTableInstrumentModelStub::class.',NULL,NULL,id', (string) $rule);
    ...
    protected function getVoyagerArrayTranslator(): Translator
    {
