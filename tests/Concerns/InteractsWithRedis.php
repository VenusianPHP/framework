...
namespace Venusian\Tests\Concerns;
...
trait InteractsWithRedis
{
     ...
     *
     * @var array<string, \Voyager\Redis\RedisManager>
     */
    private $redis;
    ...
    public function setUpRedis()
    {
        ...
        $app->registerInstance('redis', $this->redis[$defaultDriver]);
    }
