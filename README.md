...
Thank you for considering contributing to the Venusian framework! The contribution guide can be found in the [Venusian documentation](https://venusian.projectsaturnstudios.com/docs/contributions).
...
The Venusian framework is open-sourced software licensed under the [MIT license](LICENSE.md).
