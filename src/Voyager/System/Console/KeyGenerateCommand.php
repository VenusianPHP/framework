...
class KeyGenerateCommand extends Command
{
    ...
    public function handle(): void
    {
        ...
        $this->venusian['config']['app.key'] = $key;
    ...
    protected function generateRandomKey(): string
    {
        return 'base64:'.base64_encode(
            Encrypter::generateKey($this->venusian['config']['app.cipher'])
        );
    }
    ...
    {
        $currentKey = $this->venusian['config']['app.key'];
    ...
    protected function writeNewEnvironmentFileWith(string $key): bool
    {
        $replaced = preg_replace(
            ...
            'APP_KEY='.$key,
            $input = file_get_contents($this->venusian->environmentFilePath())
        );
        ...
        file_put_contents($this->venusian->environmentFilePath(), $replaced);
    ...
    {
        $escaped = preg_quote('='.$this->venusian['config']['app.key'], '/');
