...
use Voyager\Testing\Fakes\ExceptionHandlerFake;
...
trait InteractsWithExceptionHandling
{
     ...
     *
     * @var \Voyager\Contracts\Debug\ExceptionHandler|null
     */
    ...
    protected function withoutExceptionHandling(array $except = [])
    {
        ...
        $exceptionHandler = new class($this->originalExceptionHandler, $except) implements ExceptionHandler, WithoutExceptionHandlingHandler
        {
             ...
             *
             * @param  \Voyager\Contracts\Debug\ExceptionHandler  $originalHandler
             * @param  list<class-string<\Throwable>>  $except
             * @return void
             */
