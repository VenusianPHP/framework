...
use Voyager\Testing\Constraints\CountInDatabase;
use Voyager\Testing\Constraints\HasInDatabase;
use Voyager\Testing\Constraints\NotSoftDeletedInDatabase;
use Voyager\Testing\Constraints\SoftDeletedInDatabase;
...
trait InteractsWithDatabase
{
     ...
     *
     * @param  iterable<\Voyager\Database\Instrument\Model>|\Voyager\Database\Instrument\Model|class-string<\Voyager\Database\Instrument\Model>|string  $table
     ...
     *
     * @param  \Voyager\Database\Instrument\Model|class-string<\Voyager\Database\Instrument\Model>|string  $table
     * @param  int  $count
     * @param  string|null  $connection
     * @return $this
     */
     ...
     *
     * @param  iterable<\Voyager\Database\Instrument\Model>|\Voyager\Database\Instrument\Model|class-string<\Voyager\Database\Instrument\Model>|string  $model
     * @return $this
     */
     ...
     *
     * @param  string|null  $connection
     * @param  \Voyager\Database\Instrument\Model|class-string<\Voyager\Database\Instrument\Model>|string|null  $table
     ...
     *
     * @param  list<string>|class-string<\Voyager\Database\Seeder>|string  $class
     * @return $this
     */
