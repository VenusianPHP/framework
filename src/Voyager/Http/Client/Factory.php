...
/**
 * @mixin \Voyager\Http\Client\PendingRequest
 */
class Factory
{
    use Macroable {
     ...
     *
     * @var list<array{0: \Voyager\Http\Client\Request, 1: \Voyager\Http\Client\Response|null}>
     */
    protected $recorded = [];
     ...
     *
     * @var list<\Voyager\Http\Client\ResponseSequence>
     */
     ...
     * @param  int  $status
     * @param  array<string, mixed>  $headers
     * @return \Voyager\Http\Client\RequestException
     */
     ...
     * @return \Closure(\Voyager\Http\Client\Request): \GuzzleHttp\Promise\PromiseInterface
     */
     ...
     * @return \Voyager\Http\Client\ResponseSequence
     */
     ...
     *
     * @param  string  $url
     * @param  \Voyager\Http\Client\Response|\GuzzleHttp\Promise\PromiseInterface|callable|int|string|array|\Voyager\Http\Client\ResponseSequence  $callback
     * @return $this
     */
     ...
     * @param  \Voyager\Http\Client\Response|null  $response
     * @return void
     */
     ...
     *
     * @param  callable|(\Closure(\Voyager\Http\Client\Request, \Voyager\Http\Client\Response|null): bool)  $callback
     * @return void
     */
     ...
     *
     * @param  list<string|(\Closure(\Voyager\Http\Client\Request, \Voyager\Http\Client\Response|null): bool)|callable>  $callbacks
     * @return void
     */
     ...
     *
     * @param  (\Closure(\Voyager\Http\Client\Request, \Voyager\Http\Client\Response|null): bool)|callable  $callback
     * @return \Voyager\NutsAndBolts\Collection<int, array{0: \Voyager\Http\Client\Request, 1: \Voyager\Http\Client\Response|null}>
     */
