...
class DatabaseBatchRepository implements PrunableBatchRepository
{
     ...
     *
     * @param  \Voyager\Bus\BatchFactory  $factory
    ...
    /**
     * Prune every unfinished entry older than the given date.
     *
     * @param  \DateTimeInterface  $before
     * @return int
     */
    ...
    /**
     * Prune every cancelled entry older than the given date.
     *
     * @param  \DateTimeInterface  $before
     * @return int
     */
     ...
     * @return mixed
     */
    protected function unserialize(mixed $serialized): mixed
    {
