...
use Voyager\Testing\Assert as PHPUnit;
...
class AssertableJsonString implements ArrayAccess, Countable
{
     ...
     *
     * @var \Voyager\Contracts\NutsAndBolts\Jsonable|\JsonSerializable|array|string
     */
    public $json;
     ...
     *
     * @param  \Voyager\Contracts\NutsAndBolts\Jsonable|\JsonSerializable|array|string  $jsonable
     */
