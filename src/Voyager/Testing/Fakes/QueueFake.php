...
class QueueFake extends QueueManager implements Fake, Queue
{
     ...
     *
     * @var \Voyager\Contracts\Queue\Queue
     */
    public $queue;
     ...
     * @param  \Voyager\Queue\QueueManager|null  $queue
     */
     ...
     * @return \Voyager\NutsAndBolts\Collection<int, RawPushType>
     */
     ...
     * @param  (\Closure(mixed, \Voyager\Events\CallQueuedListener, string|null, mixed): bool)|null  $callback
     * @return \Voyager\NutsAndBolts\Collection<int, \Voyager\Events\CallQueuedListener>
     */
