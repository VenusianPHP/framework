...
class BusFake implements Fake, QueueingDispatcher
{
     ...
     *
     * @var \Voyager\Contracts\Bus\QueueingDispatcher
     */
    public $dispatcher;
     ...
     *
     * @var \Voyager\Bus\BatchRepository
     */
     ...
     *
     * @param  \Voyager\Contracts\Bus\QueueingDispatcher  $dispatcher
     * @param  array|string  $jobsToFake
     * @param  \Voyager\Bus\BatchRepository|null  $batchRepository
     */
     ...
     * @return \Voyager\Testing\Fakes\ChainedBatchTruthTest
     */
     ...
     *
     * @param  array|callable(\Voyager\Bus\PendingBatch): bool  $callback
     * @return void
     */
     ...
     *
     * @param  callable(\Voyager\Bus\PendingBatch): bool  $callback
     * @return \Voyager\NutsAndBolts\Collection<int, \Voyager\Bus\PendingBatch>
     */
