...
class BatchRepositoryFake implements BatchRepository
{
     ...
     */
    public function find(string $batchId): ?\Voyager\Bus\Batch
    {
     ...
     */
    public function decrementPendingJobs(string $batchId, string $jobId): \Voyager\Bus\UpdatedBatchJobCounts
    {
     ...
     * @return \Voyager\Bus\UpdatedBatchJobCounts
     */
    public function incrementFailedJobs(string $batchId, string $jobId): \Voyager\Bus\UpdatedBatchJobCounts
    {
        return new UpdatedBatchJobCounts;
    }
