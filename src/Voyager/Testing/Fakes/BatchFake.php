...
class BatchFake extends Batch
{
     ...
     *
     * @param  \Voyager\NutsAndBolts\Contracts\Enumerable|object|array  $jobs
     * @return self
     */
     ...
     * @return void
     */
    public function decrementPendingJobs(string $jobId): \Voyager\Bus\UpdatedBatchJobCounts
    {
        //
    }
     ...
     */
    public function incrementFailedJobs(string $jobId): \Voyager\Bus\UpdatedBatchJobCounts
    {
