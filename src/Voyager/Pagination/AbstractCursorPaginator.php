 ...
 *
 * @mixin \Voyager\NutsAndBolts\Collection<TKey, TValue>
 */
abstract class AbstractCursorPaginator implements Stringable
{
     ...
     *
     * @var \Voyager\NutsAndBolts\Collection<TKey, TValue>
     */
    protected $items;
     ...
     * The current cursor.
     *
     * @var \Voyager\Pagination\Cursor|null
     */
    protected $cursor;
     ...
     * @param  bool  $isNext
     * @return \Voyager\Pagination\Cursor
     */
     ...
     * @param  \Voyager\Pagination\Cursor|null  $default
     * @return \Voyager\Pagination\Cursor|null
     */
     ...
     * @template TSetValue
     *
     * @param  \Voyager\NutsAndBolts\Collection<TSetKey, TSetValue>  $collection
     * @return $this
     *
