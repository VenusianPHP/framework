...
namespace Voyager\Redis\Connectors;
...
use Voyager\NutsAndBolts\MagicAliases\Redis as RedisFacade;
...
class PhpRedisConnector implements Connector
{
     ...
     * @param  array  $config
     * @param  array  $options
     * @return \Voyager\Redis\Connections\PhpRedisConnection
     */
     ...
     * @param  array  $options
     * @return \Voyager\Redis\Connections\PhpRedisClusterConnection
     */
