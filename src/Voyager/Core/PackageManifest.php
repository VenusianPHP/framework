...
class PackageManifest
{
     ...
     * @var array
     */
    public ?array $manifest = null;      // null = not read yet; [] is a real, empty manifest
    ...
    protected function write(array $manifest): void
    {
        ...
        $this->manifest = $manifest;          // what was just written is what we hold
    }
}
