...
class PendingChain
{
     ...
     * @param  array  $chain
     */
    public function __construct(mixed $job, array $chain)
    {
        $this->job = $job;
        $this->chain = $chain;
    }
     ...
     *
     * @return \Voyager\Core\Bus\PendingDispatch
     */
     ...
     * @return \Voyager\Core\Bus\PendingDispatch|null
     */
