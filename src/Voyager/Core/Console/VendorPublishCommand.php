...
use Carbon\Carbon;
use Voyager\Core\Signals\VendorTagPublished;
...
class VendorPublishCommand extends Command
{
    ...
    protected function publishTag(?string $tag): void
    {
        ...
        if ($publishing === false) {
            ...
            $this->venusian['signals']->dispatch(new VendorTagPublished($tag, $pathsToPublish));
     ...
     * @return void
     */
    protected function moveManagedFiles(string $from, \League\Flysystem\MountManager $manager): void
    {
