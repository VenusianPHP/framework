...
class EventListCommand extends Command
{
     ...
     * @var string
     */
    protected ?string $signature = 'signal:list
     ...
     */
    protected function getEvents(): \Voyager\NutsAndBolts\Collection
    {
     ...
     * @return \Voyager\NutsAndBolts\Collection
     */
    protected function filterEvents(\Voyager\NutsAndBolts\Collection $events): \Voyager\NutsAndBolts\Collection
    {
     ...
     *
     * @return \Voyager\Signals\SignalDispatcher
     *
     * @throws \Voyager\Contracts\Container\BindingResolutionException
     */
    public function getEventsDispatcher(): \Voyager\Signals\SignalDispatcher
    {
        return is_null(self::$eventsResolver)
            ? $this->getVenusian()->make('signals')
